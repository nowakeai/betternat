...
- Keep nftables/nf_conntrack as a mandatory fallback and debugging baseline.
...
- `internal/datapath/nftables`: nftables fallback wrapper and parsers.
...
- Real LoxiLB/nftables datapath behavior requires Linux.
